...
import { warnMember, replyAction } from "../../modules/moderation/actions.js";
...
const command: Command = {
  ...
  async execute(interaction: ChatInputCommandInteraction, client: NexoClient) {
    ...
    await replyAction(interaction, await warnMember(interaction.guild!, staff, member, interaction.options.getString("razon", true), client));
  },
};
